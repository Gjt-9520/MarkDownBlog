...
title: "循环语句"
date: 2023-12-16
description: "for循环、while循环、无限循环、条件控制语句"
cover: https://github.com/Gjt-9520/ImageResources/blob/main/photos/original/Ximage59.jpg?raw=true
tags: ["Java基础"]
category: "学习笔记"
updated: 2023-12-16
---
...
如果是`false`,循环结束,执行循环下面的其他语句  
如果是`true`,执行循环体语句,执行条件控制语句,回到2继续执行条件判断语句  
