...
title: "包装类综合练习"
date: 2024-01-24
description: "键盘录入、实现parseInt方法的效果、实现toBinaryString方法的效果、计算寿命、判断年份是闰年还是平年"
cover: https://github.com/Gjt-9520/ImageResources/blob/main/photos/original/Ximage3.jpg?raw=true
tags: ["Java基础","API","练习"]
category: "学习笔记"
updated: 2024-01-24
---
...
用代码实现你活了多少了天,用`JDK7`和`JDK8`两种方式完成
