...
date: 2023-11-30
description: "快捷键、技巧"
cover: https://github.com/Gjt-9520/ImageResources/blob/main/photos/original/Ximage82.jpg?raw=true
tags: ["编译器"]
category: "学习笔记"
updated: 2023-11-30
---
...
`project`(项目)包含了`module`(模块)包含了`package`(包)包含了`class`(类)
...
定义: `Java`已经写好一个类叫`Scanner`,这个类可以接收键盘输入的数字   
