...
title: "字符串综合练习"
date: 2023-12-30
description: "罗马数字、调整字符串、打乱键盘录入的任意字符串、生成验证码、统计字符串中的英文字母和数字个数、返回两数的乘积值、判断对称字符串、判断身份证、数组按要求打印、输出字符串中最后一个单词的长度、统计文本中关键词的出现次数"
cover: https://github.com/Gjt-9520/ImageResources/blob/main/photos/original/Ximage68.jpg?raw=true
tags: ["Java基础","练习"]
category: "学习笔记"
updated: 2023-12-30
---
