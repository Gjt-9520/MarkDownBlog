...
cover: https://github.com/Gjt-9520/ImageResources/blob/main/photos/original/Ximage98.jpg?raw=true
tags: ["Java基础","面向对象"]
category: "学习笔记"
updated: 2024-01-04
---
...
`static`表示静态,是`Java`的一个修饰符,可以修饰成员方法、成员变量    
...
3. 定义一个测试类`TestDemo`,调用该工具类的工具方法,并返回结果   
...
3. **静态方法中没有`this`关键字**    
解释: 非静态方法往往是和对象相关的,所以虚拟机会默认隐藏`this`关键字   
而静态方法是共享的,和某一个对象无关,所以静态方法中没有`this`关键字  
