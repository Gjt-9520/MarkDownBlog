...
date: 2024-04-24
description: ""
cover: https://github.com/Gjt-9520/Resource/blob/main/Blogimage/project/ChatRoom/ChatRoom_Chat.png?raw=true
...
![登录界面](https://github.com/Gjt-9520/Resource/blob/main/Blogimage/project/ChatRoom/ChatRoom_Login.png?raw=true)

注册界面:

![注册界面](https://github.com/Gjt-9520/Resource/blob/main/Blogimage/project/ChatRoom/ChatRoom_Register.png?raw=true)

聊天界面:

![聊天界面](https://github.com/Gjt-9520/Resource/blob/main/Blogimage/project/ChatRoom/ChatRoom_Chat.png?raw=true)

# 代码

文件组成:

![文件组成](https://github.com/Gjt-9520/Resource/blob/main/Blogimage/project/ChatRoom/ChatRoom_Set.png?raw=true)
