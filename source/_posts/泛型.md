...
title: "泛型"
date: 2024-03-16
description: "格式、注意事项、好处、拓展、细节、多种定义(泛型类、泛型方法、泛型接口)、继承和通配符"
cover: https://github.com/Gjt-9520/ImageResources/blob/main/photos/original/Ximage16.jpg?raw=true
tags: ["Java进阶"]
category: "学习笔记"
updated: 2024-03-16
---
...
1. **泛型只能支持引用数据类型**
2. **如果没有给集合指定类型,默认认为所有的数据类型都是`Object`类型**                  
此时,可以往集合添加任意的数据类型             
