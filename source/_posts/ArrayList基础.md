...
cover: https://github.com/Gjt-9520/ImageResources/blob/main/photos/original/Ximage71.jpg?raw=true
tags: ["Java基础","集合"]
category: "学习笔记"
updated: 2024-01-01
---
...
创建的是`ArrayList`的对象,而`ArrayList`是`Java`已经写好的一个类,这个类在底层做了一些处理:   
...
2. 如果存在,则返回`true`;如果不存在,则返回`false`   
